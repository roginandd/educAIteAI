...
export const envSchema = z.object({
  ...
  GOOGLE_GENAI_FLASH_MODEL: z.string().min(1).default("gemini-2.5-flash"),
  GOOGLE_GENAI_SMART_QUIZ_MODEL: optionalEnvStringSchema,
  GOOGLE_GENAI_SMART_QUIZ_GENERATION_MODEL: optionalEnvStringSchema,
  GOOGLE_GENAI_SMART_QUIZ_PDF_MODEL: optionalEnvStringSchema,
...
export const env: Env = envSchema.parse({
  ...
  GOOGLE_GENAI_FLASH_MODEL: process.env.GOOGLE_GENAI_FLASH_MODEL,
  GOOGLE_GENAI_SMART_QUIZ_MODEL: process.env.GOOGLE_GENAI_SMART_QUIZ_MODEL,
  GOOGLE_GENAI_SMART_QUIZ_GENERATION_MODEL: process.env.GOOGLE_GENAI_SMART_QUIZ_GENERATION_MODEL,
  GOOGLE_GENAI_SMART_QUIZ_PDF_MODEL: process.env.GOOGLE_GENAI_SMART_QUIZ_PDF_MODEL,
